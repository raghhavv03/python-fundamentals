...
class Message:
    ...
    def __str__(self):  # Returns a human-readable representation of the message.
...
class ChatRoom:
    ...
    def broadcast_message(self, sender, content):
        ...
        print(
            message
        )  # Python automatically calls __str__ when printing the Message object.

    def show_chat_history(self):
        print(f"Chat history for {self.name}:")
        for message in self.messages:
            print(message)
        print()  # Adds a newline after the chat history.


if __name__ == "__main__":  # Test the chat room functionality.
